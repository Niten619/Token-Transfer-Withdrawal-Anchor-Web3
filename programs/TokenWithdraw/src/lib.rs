...
// declare_id!("3ERnPj1gQnKzagvWCjqZGskJszcLhunXuLfYqjuSvxBW");  // roshan's sc
// declare_id!("2RNuwhYFrXZDm5e9bb15ypf2Y49RMu7FhtqaGUe8R8BP");  // made by 'solana-keypair new'
declare_id!("FkyTHcX3izEyEoMEwqpQhZ9qLqwv37FMJg345pzej7KM");  // got from 'solana address -k target/deploy/mysolanaapp-keypair.json'
